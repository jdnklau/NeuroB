...
public class Z3Backend extends Backend {
     ...
     */
    public Z3Backend(BPreference... preferences) {
        super(preferences);
    }
     ...
     * @param preferences Preferences to be set.
     */
    public Z3Backend(long timeOutValue, TimeUnit timeOutUnit, BPreference... preferences) {
     ...
     * @param preferences Preferences to be set
     */
    public Z3Backend(BPreferences preferences) {
        super(preferences);
    }
     ...
     * @param preferences Preferences to be set.
     */
    public Z3Backend(long timeOutValue, TimeUnit timeOutUnit, BPreferences preferences) {
        super(timeOutValue, timeOutUnit, preferences);
    }
