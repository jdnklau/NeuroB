...
public class BAst275Features extends PredicateFeatures {

    public static final int FEATURE_DIMENSION = 275;

    public BAst275Features(BPredicate predicate, Double[] features) {
