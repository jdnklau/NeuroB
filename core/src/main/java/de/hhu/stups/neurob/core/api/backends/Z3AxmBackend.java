...
public class Z3AxmBackend extends Backend {
     ...
     */
    public Z3AxmBackend(BPreference... preferences) {
        super(preferences);
    }
     ...
     * @param preferences Preferences to be set.
     */
    public Z3AxmBackend(long timeOutValue, TimeUnit timeOutUnit, BPreference... preferences) {
     ...
     * @param preferences Preferences to be set
     */
    public Z3AxmBackend(BPreferences preferences) {
        super(preferences);
    }
     ...
     * @param preferences Preferences to be set.
     */
    public Z3AxmBackend(long timeOutValue, TimeUnit timeOutUnit, BPreferences preferences) {
        super(timeOutValue, timeOutUnit, preferences);
    }

    @Override
    public CbcSolveCommand.Solvers toCbcEnum() {
        return CbcSolveCommand.Solvers.Z3AXM;
    }
