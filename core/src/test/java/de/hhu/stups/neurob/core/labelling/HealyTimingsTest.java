...
class HealyTimingsTest {
    ...
    public void shouldUseProBAndZ3Backends() throws LabelCreationException {
        HealyTimings timings =
                new HealyTimings(BPredicate.of("predicate"), machineAccess, prob, z3);
    ...
    public void shouldOrderLabelsAccordingToBackendOrder() {
        ...
        HealyTimings timings = new HealyTimings(BPredicate.of("pred"), input,
                new SmtBackend(),
                new Z3Backend(),
                new KodkodBackend(),
                new ProBBackend());
    ...
    public void shouldSetTimeOfUnmappedBackendsToNegativeOne() {
        ...
        HealyTimings timings = new HealyTimings("pred", input,
                new SmtBackend(),
                new Z3Backend(),
                new KodkodBackend(),
                new ProBBackend());
    ...
    public void shouldMatchBackendsAndTimingsByOrder() {
        ...
        HealyTimings timings = new HealyTimings("pred", backends,
    ...
    public void shouldReturn1AsLabellingDimensionWhenOnlyOneBackEndProvided()
        ...
        HealyTimings timings = new HealyTimings("predicate", machineAccess, prob);
    ...
    public void shouldReturn3AsLabellingDimensionWhenThreeBackendsAreProvided()
            throws LabelCreationException {
        HealyTimings timings =
                new HealyTimings("predicate", machineAccess, prob, kodkod, z3);
    ...
    public void shouldSampleTimeOnce() throws Exception {
        ...
        when(prob.solvePredicate(predicate, machineAccess,
                HealyTimings.defaultTimeout, HealyTimings.defaultTimeoutUnit))
    ...
    void shouldSampleForEachBackend() throws Exception {
        ...
        HealyTimings timings = new HealyTimings(predicate, machineAccess, prob, kodkod);
    ...
    public void shouldSampleOnceWhenUsingGenerator() throws Exception {
        ...
        HealyTimings timings =
                new HealyTimings.Generator(prob)
    ...
    public void shouldSampleThriceWhenSamplingSizeIsThree() throws Exception {
        ...
        List<HealyTimings> timings =
                new HealyTimings.Generator(prob)
                        .generateSamples(predicate, bMachine, 3);

        double[] expected = {1., 2., 6.};
        double[] actual = timings.stream().mapToDouble(d -> d.calcHealyCost(d.getTiming(prob))).toArray();
    ...
    void shouldSampleThriceForEachBackendWhenUsingGenerator() throws Exception {
        ...
        List<HealyTimings> timings =
                new HealyTimings.Generator(prob, kodkod)
                        .generateSamples(predicate, bMachine, 3);

        double[] probExpected = {1., 2., 6.};
        double[] probActual = timings.stream().mapToDouble(d -> d.calcHealyCost(d.getTiming(prob))).toArray();

        double[] kodkodExpected = {4., 12., 5.};
        double[] kodkodActual = timings.stream().mapToDouble(d -> d.calcHealyCost(d.getTiming(kodkod))).toArray();
    ...
    public void shouldThrowExceptionWhenTimeOfOneBackendCannotBeMeasured()
        ...
        assertThrows(LabelCreationException.class,
                () -> new HealyTimings(predicate, machineAccess, prob, kodkod),
    ...
    void shouldUseTimeAsCostWhenSolvableResponse() throws LabelCreationException {
        HealyTimings timings =
                new HealyTimings(BPredicate.of("predicate"),
        ...
        assertAll(
                () -> assertEquals(1L, timings.calcHealyCost(valid).longValue()),
                () -> assertEquals(1L, timings.calcHealyCost(invalid).longValue()),
                () -> assertEquals(1L, timings.calcHealyCost(solvable).longValue())
        );
    }
    ...
    void shouldAddTimeoutToCostWhenUnknownResponse() throws LabelCreationException {
        ...
        assertEquals(51L, timings.calcHealyCost(unknown).longValue());
    }

    @Test
    void shouldAddDoubleTimeoutToCostWhenErrorOrTimeout() throws LabelCreationException {
        HealyTimings timings =
                new HealyTimings(BPredicate.of("predicate"),
        ...
        assertAll(
                () -> assertEquals(10015L, timings.calcHealyCost(error).longValue()),
                () -> assertEquals(10051L, timings.calcHealyCost(timeout).longValue())
        );
    }
