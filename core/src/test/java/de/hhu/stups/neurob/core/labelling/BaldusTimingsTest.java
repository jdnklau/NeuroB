...
class BaldusTimingsTest {
    ...
    public void shouldUseProBAndZ3Backends() throws LabelCreationException {
        BaldusTimings timings =
                new BaldusTimings(BPredicate.of("predicate"), machineAccess, prob, z3);
    ...
    public void shouldOrderLabelsAccordingToBackendOrder() {
        ...
        BaldusTimings timings = new BaldusTimings(BPredicate.of("pred"), input,
                new SmtBackend(),
                new Z3Backend(),
                new KodkodBackend(),
                new ProBBackend());
    ...
    public void shouldSetTimeOfUnmappedBackendsToNegativeOne() {
        ...
        BaldusTimings timings = new BaldusTimings("pred", input,
                new SmtBackend(),
                new Z3Backend(),
                new KodkodBackend(),
                new ProBBackend());
    ...
    public void shouldMatchBackendsAndTimingsByOrder() {
        ...
        BaldusTimings timings = new BaldusTimings("pred", backends,
    ...
    public void shouldReturn1AsLabellingDimensionWhenOnlyOneBackEndProvided()
        ...
        BaldusTimings timings = new BaldusTimings("predicate", machineAccess, prob);
    ...
    public void shouldReturn3AsLabellingDimensionWhenThreeBackendsAreProvided()
            throws LabelCreationException {
        BaldusTimings timings =
                new BaldusTimings("predicate", machineAccess, prob, kodkod, z3);
    ...
    public void shouldSampleTimeOnce() throws Exception {
        ...
        when(prob.solvePredicate(predicate, machineAccess,
                BaldusTimings.defaultTimeout, BaldusTimings.defaultTimeoutUnit))
    ...
    void shouldSampleForEachBackend() throws Exception {
        ...
        BaldusTimings timings = new BaldusTimings(predicate, machineAccess, prob, kodkod);
    ...
    public void shouldSampleOnceWhenUsingGenerator() throws Exception {
        ...
        BaldusTimings timings =
                new BaldusTimings.Generator(prob)
    ...
    public void shouldSampleThriceWhenSamplingSizeIsThree() throws Exception {
        ...
        List<BaldusTimings> timings =
                new BaldusTimings.Generator(prob)
                        .generateSamples(predicate, bMachine, 3);

        double[] expected = {1., 2., 6.};
        double[] actual = timings.stream().mapToDouble(d -> d.calcBaldusCost(d.getTiming(prob))).toArray();
    ...
    void shouldSampleThriceForEachBackendWhenUsingGenerator() throws Exception {
        ...
        List<BaldusTimings> timings =
                new BaldusTimings.Generator(prob, kodkod)
                        .generateSamples(predicate, bMachine, 3);

        double[] probExpected = {1., 2., 6.};
        double[] probActual = timings.stream().mapToDouble(d -> d.calcBaldusCost(d.getTiming(prob))).toArray();

        double[] kodkodExpected = {4., 12., 5.};
        double[] kodkodActual = timings.stream().mapToDouble(d -> d.calcBaldusCost(d.getTiming(kodkod))).toArray();
    ...
    public void shouldThrowExceptionWhenTimeOfOneBackendCannotBeMeasured()
        ...
        assertThrows(LabelCreationException.class,
                () -> new BaldusTimings(predicate, machineAccess, prob, kodkod),
    ...
    void shouldUseTimeAsCostWhenSolvableResponse() throws LabelCreationException {
        BaldusTimings timings =
                new BaldusTimings(BPredicate.of("predicate"),
        ...
        assertAll(
                () -> assertEquals(1L, timings.calcBaldusCost(valid).longValue()),
                () -> assertEquals(1L, timings.calcBaldusCost(invalid).longValue()),
                () -> assertEquals(1L, timings.calcBaldusCost(solvable).longValue())
        );
    }
    ...
    void shouldAddTimeoutToCostWhenUnknownResponse() throws LabelCreationException {
        ...
        assertEquals(51L, timings.calcBaldusCost(unknown).longValue());
    }
    ...
    void shouldAddTimeoutToCostWhenErrorOrTimeout() throws LabelCreationException {
        ...
        assertAll(
                () -> assertEquals(5015L, timings.calcBaldusCost(error).longValue()),
                () -> assertEquals(5051L, timings.calcBaldusCost(timeout).longValue())
        );
    }
